...
public class XmlStateService
{
    ...
    public void AddCard(int id, string type, double x, double y, int input1 = 0, int input2 = 0,
        bool initialValue = false)
    {
        switch (type)
        {
            case "Input":
                AddInputCard(id, initialValue, x, y);
                break;
            case "Output":
                AddOutputCard(id, input1, x, y);
                break;
            default:
                AddLogicGateCard(id, type, input1, input2, x, y);
                break;
        }
    }
    ...
    // updates card input
    public void SetCardInput(int targetCardId, int portIndex, int senderCardId)
    {
    ...
    public void SetCardPosition(int id, double xPos, double yPos)
    {
